...
<a href="https://developer.mozilla.org/en-US/docs/Web/TypeScript" title="Type Script"><img src="https://github.com/tomchen/stack-icons/blob/master/logos/typescript.svg" alt="TypeScript" width="21px" height="21px"></a>
...
-  **Technologies Stack :** JavaScript, TypeScript, React, Redux, GraphQL, ReduxToolkit, RTK-Query, HTML, CSS, SCSS, Tailwind, Material UI, Chakra UI ... (<i>to be continued</i> :wink:)
